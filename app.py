...
# --- 🔐 Gmail SMTP Credentials (Direct) ---
SMTP_SERVER = 'smtp.gmail.com'
SMTP_PORT = 587
SMTP_USERNAME = 'armanhacker900@gmail.com'
SMTP_PASSWORD = 'mmge jjmr clrk dqnb'
...
def booking():
    if request.method == 'POST':
        ...
        try:
            ...
            flash(f"Booking saved but email failed: {e}", "warning")
            print("SMTP Error:", e)
...
def promotions():
    ...
    if request.method == 'POST':
        ...
        if action == 'generate':
            discount = secrets.randbelow(41) + 10

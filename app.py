...
SENDGRID_API_KEY = os.getenv('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')
    ...
    if request.method == 'POST':
        ...
        if SENDGRID_API_KEY:
            message = Mail(
                ...
                to_emails=phone + 'armanhacker900@gmail.com',  # Replace with actual email in production
                subject='TEAM 4OR Booking Confirmation',
                html_content=f'''
